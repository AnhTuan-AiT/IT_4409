...
const approveBtnStyle = { marginTop: 32, marginRight: 16 };
...
function RegistrationDetail(props) {
  ...
  const handleApprove = () => {
    ...
    request(
      ...
      {
        url: `${AUTH_SERVICE_BASE_URL}/user/approve-registration-send-email-for-activation`,
      }
    );
  };
  const handleDisable = () => {
    ...
    request(
      ...
      { userLoginId: data.id },
      {
        url: `${AUTH_SERVICE_BASE_URL}/user/disable-registration`,
      }
    );
  };
