...
*/
  ...
  const getStudents = (type) => {
    if (type === "register") {
      request(
        "get",
        `/edu/class-management/class/registered-students?id=${params.id}`,
        (res) => {
      ...
      request(
        "get",
        `/edu/class-management/class/students?id=${params.id}`,
        (res) => {
  ...
  const getAssigns = () => {
    request(
      "get",
      `/edu/class-management/class/assignments/teacher?id=${params.id}`,
      (res) => {
  ...
  const getStudentAssignment = () => {
    request(
      "get",
      `/edu/class-management/class/all-student-assignments/teacher?id=${params.id}`,
      (res) => {
