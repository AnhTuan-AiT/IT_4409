...
function TAssignmentDetail() {
  ...
  const getAssignDetail = () => {
    request(
      "get",
      `/edu/class-management/assignment/teacher?assignmentId=${params.assignmentId}`,
      (res) => {
        ...
        // Sort by name
        data.sort(function (sub1, sub2) {
          return sub1.name.localeCompare(sub2.name);
        });
  ...
  //   form.setAttribute(
  //     "action",
  //     `${AUTH_SERVICE_BASE_URL}/edu/assignment/${params.assignmentId}/submissions?token=${token}`
  //   );
  ...
  const onDeleteAssign = () => {
    ...
    request(
      "delete",
      `/edu/class-management/assignment/?assignmentId=${params.assignmentId}`,
      () => {
        history.goBack();
      },
      {
              ...
              <Grid container md={12}>
                ...
                <Grid item md={8} sm={8} xs={8} direction="column">
                  ...
                  {assignDetail.startTime ? (
                    <div className={classes.assignDetail}>
                      <Typography>
                        :&nbsp;{displayTime(assignDetail.startTime)}
                      </Typography>
                    </div>
                  ) : (
                    <>:</>
                  ...
                  {assignDetail.endTime ? (
                    <div className={classes.assignDetail}>
                      <Typography>
                        :&nbsp;{displayTime(assignDetail.endTime)}
                      </Typography>
                    </div>
                  ) : (
                    <b>
                ...
                <Box display="flex" width="100%">
                  ...
                  <Grid item md={8} sm={8} xs={8}>
                    {assignDetail.noSubmissions === undefined ? (
                      ...
                      <Typography>: {assignDetail.noSubmissions}</Typography>
                    )}
                  </Grid>
                </Box>
              </Grid>
            ...
            actions={[
              {
                ...
                onClick: () => onDownload(selectedSubmissions),
              },
            ]}
      ...
      <CustomizedDialogs
        ...
        content={
          <Typography gutterBottom>
            ...
            <br />
            <b>Cảnh báo: Hành động này không thể hoàn tác.</b>
          </Typography>
        }
        actions={
          <PositiveButton
